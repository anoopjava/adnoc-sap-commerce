 ...
 */
package com.adnoc.fulfilmentprocess.test;
...
import com.adnoc.fulfilmentprocess.constants.AdnocFulfilmentProcessConstants;
import com.adnoc.fulfilmentprocess.test.events.TestEventListenerCountingEvents;
...
public class FraudCheckIntegrationTest extends ServicelayerTest
{
	...
	/**
	 * Load bean definition from adnocfulfilmentprocess-spring-test-fraudcheck.xml
	 */
	@BeforeClass
	public static void beforeClass()
	{
		...
		xmlReader.loadBeanDefinitions(new ClassPathResource(
				"/adnocfulfilmentprocess/test/adnocfulfilmentprocess-spring-test-fraudcheck.xml"));
	...
	protected static final String PARAM_NAME_MIN_PERIOD_WAITING_FOR_CLEANUP_IN_SECONDS = "adnocfulfilmentprocess.fraud.minPeriodWaitingForCleanUpInSeconds";
	protected static final String PARAM_NAME_FRAUD_SCORE_LIMIT = "adnocfulfilmentprocess.fraud.scoreLimit";
	protected static final String PARAM_NAME_FRAUD_SCORE_TOLERANCE = "adnocfulfilmentprocess.fraud.scoreTolerance";
	...
	public void before() throws Exception
	{
		...
		{
			importCsv("/adnocfulfilmentprocess/test/testTicketEssentialData.csv", "utf-8");
		}
		importCsv("/adnocfulfilmentprocess/test/testWarehouses.csv", "utf-8");
	...
	{
		final String processDefinitionName = AdnocFulfilmentProcessConstants.ORDER_PROCESS_NAME;
	...
	protected String submitOrderMock(final OrderModel order)
	{
		final OrderProcessModel businessProcessModel = (OrderProcessModel) businessProcessService.createProcess(
				AdnocFulfilmentProcessConstants.ORDER_PROCESS_NAME + order.getCode() + +System.currentTimeMillis(),
				AdnocFulfilmentProcessConstants.ORDER_PROCESS_NAME);
	...
	public void testUsersOrderIsEvaluatedAsFraudButUserIntervene() throws InvalidCartException, CalculationException
	{
        ...
        Assert.assertEquals(Boolean.TRUE, order.getFraudulent());
	...
	/**
	 * Test scenario: Users order is evaluated as a potential fraud, but CS Agent decide that order is fraudulent and
	 * after specific period of time order should have status CANCELLED
	 *
	 * @throws InvalidCartException
	 * @throws CalculationException
	 * @throws InterruptedException
