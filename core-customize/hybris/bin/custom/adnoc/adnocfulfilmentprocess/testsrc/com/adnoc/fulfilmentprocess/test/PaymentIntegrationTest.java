...
public class PaymentIntegrationTest extends ServicelayerTest
{
	...
	public static void prepare() throws Exception
	{
		...
		definitonFactory.add("classpath:/adnocfulfilmentprocess/test/process/payment-process.xml");
	...
	public void setUpProductCatalogue()
	{
		try
		{
			...
			importCsv("/adnocfulfilmentprocess/test/testBasics.csv", "windows-1252");
			importCsv("/adnocfulfilmentprocess/test/testCatalog.csv", "windows-1252");
