 ...
 */
package com.adnoc.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception
	{
		...
		warehouseCounter.setName(AdnocFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(AdnocFulfilmentProcessConstants.PARENT_PROCESS);
