...
public class AdnocVerificationTokenController extends AdnocBaseController
{
    ...
    @Resource(name = "createVerificationTokenInputValidator")
    ...
    public VerificationTokenWsDTO createVerificationToken(@Parameter(description = "Object contains information for obtaining a verification token.", required = true) @RequestBody final CreateVerificationTokenInputWsDTO createVerificationTokenInputWsDTO)
    {
