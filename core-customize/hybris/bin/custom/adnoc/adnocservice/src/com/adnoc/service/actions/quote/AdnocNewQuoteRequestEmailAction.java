...
/* When customer submits the Quote this file will notify the CsAdmin (CS Cockpit)*/
public class AdnocNewQuoteRequestEmailAction extends GenerateEmailAction
{
    private static final Logger LOG = LogManager.getLogger(AdnocNewQuoteRequestEmailAction.class);
    ...
    public Transition executeAction(final BusinessProcessModel businessProcessModel) throws RetryLaterException
    {
        ...
        if (transition == Transition.OK)
        {
            ...
            {
                LOG.error("appEvent=AdnocNewQuoteEmailValidation, No valid admin email addresses generated.");
    ...
    private List<EmailAddressModel> createEmailsAddressForEmail(final List<String> emails)
    {
        ...
        if (CollectionUtils.isNotEmpty(emails))
        {
            ...
            {
                LOG.info("appEvent=AdnocNewQuoteEmailAddressCreation, processing email address: {}", email);
