 ...
 */
package com.adnoc.service.suggestion;
...
public interface SimpleSuggestionService
{
	 ...
	 *
	 * @param category         the category for which to retrieve references
	 * @param user             the user for whom to retrieve references
	 * @param referenceType    optional referenceType
	 ...
	 *
	 * @param products         the list of products for which to retrieve references
	 * @param user             the user for whom to retrieve references
	 * @param referenceTypes   optional referenceTypes
	 * @param excludePurchased if true, only retrieve products that have not been purchased by the user
	 * @param limit            if not null: limit the amount of returned products to the given number
