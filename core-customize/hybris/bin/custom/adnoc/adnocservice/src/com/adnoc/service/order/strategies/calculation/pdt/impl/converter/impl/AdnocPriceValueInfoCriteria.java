...
public class AdnocPriceValueInfoCriteria implements PriceValueInfoCriteria
{
    ...
    private final AddressModel shippingAddress;
    private final String incoTerms;

    AdnocPriceValueInfoCriteria(final Builder builder)
    {
    ...
    public static class Builder
    {
        ...
        public Builder withShippingAddress(final AddressModel shippingAddress)
        {
            this.shippingAddress = shippingAddress;
            return this;
        }

        public Builder withIncoTerms(final String incoTerms)
        {
            this.incoTerms = incoTerms;
            return this;
        }

        public AdnocPriceValueInfoCriteria build()
        {
            return new AdnocPriceValueInfoCriteria(this);
        }
    }
}
