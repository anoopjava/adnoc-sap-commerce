 ...
 */
package com.adnoc.service.search.solrfacetsearch.provider.impl;
...
{
	private static final Logger LOG = Logger.getLogger(VolumeAwareProductPriceValueProvider.class.getName());
