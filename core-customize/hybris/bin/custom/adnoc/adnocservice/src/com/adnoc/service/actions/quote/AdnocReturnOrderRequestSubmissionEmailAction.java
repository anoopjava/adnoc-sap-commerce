...
public class AdnocReturnOrderRequestSubmissionEmailAction extends GenerateEmailAction
{
    private static final Logger LOG = LogManager.getLogger(AdnocReturnOrderRequestSubmissionEmailAction.class);
    ...
    public Transition executeAction(final BusinessProcessModel businessProcessModel) throws RetryLaterException
    {
        ...
        if (transition == Transition.OK)
        {
            ...
            {
                LOG.error("appEvent=AdnocReturnOrderEmailValidation, No valid admin email addresses generated.");
    ...
    private List<EmailAddressModel> createEmailsAddressForEmail(final List<String> emails)
    {
        ...
        if (CollectionUtils.isNotEmpty(emails))
        {
            ...
            {
                LOG.info("appEvent=AdnocReturnOrderEmailAddressCreation, processing email address: {}", email);
