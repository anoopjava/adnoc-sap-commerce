...
public class AbstractAdnocB2BAdminEmailActionTest
{
    @InjectMocks
    private AbstractAdnocB2BAdminEmailAction abstractAdnocB2BAdminEmailAction = new AbstractAdnocB2BAdminEmailAction();
    @Mock
    ...
    public void testExecuteActionOk() throws RetryLaterException
    {
        ...
        final GenerateEmailAction.Transition result = abstractAdnocB2BAdminEmailAction.executeAction(adnocB2BCustomerCreationProcessModel);
    ...
    public void testExecuteActionNotOk() throws RetryLaterException
    {
        ...
        final AbstractAdnocB2BAdminEmailAction.Transition result = abstractAdnocB2BAdminEmailAction.executeAction(businessProcessModel);
        assertEquals(AbstractAdnocB2BAdminEmailAction.Transition.NOK, result);
    }
}