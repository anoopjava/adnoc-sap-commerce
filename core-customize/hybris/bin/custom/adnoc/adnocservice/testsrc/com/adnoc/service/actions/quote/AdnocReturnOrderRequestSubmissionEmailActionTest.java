...
public class AdnocReturnOrderRequestSubmissionEmailActionTest
{
    @InjectMocks
    private AdnocReturnOrderRequestSubmissionEmailAction adnocQuoteRequestResubmissionEmailAction = new AdnocReturnOrderRequestSubmissionEmailAction();
    @Mock
    ...
    public void testExecuteActionOk() throws RetryLaterException
    {
        ...
        final String email1 = "adminEmail@example.com";
        final String email2 = "adminEmail@example.com";
        ...
        final GenerateEmailAction.Transition result = adnocQuoteRequestResubmissionEmailAction.executeAction(businessProcessModel);
    ...
    {
        final List<EmailMessageModel> emailMessageModelList = new ArrayList<>();
        final EmailMessageModel emailMessage = Mockito.mock(EmailMessageModel.class);
        emailMessageModelList.add(emailMessage);
