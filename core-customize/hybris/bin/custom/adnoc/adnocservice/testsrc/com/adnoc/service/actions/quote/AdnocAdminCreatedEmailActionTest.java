...
public class AdnocAdminCreatedEmailActionTest
{
    @InjectMocks
    private AdnocAdminCreatedEmailAction adnocAdminCreatedEmailAction;
    @Mock
    ...
    public void testExecuteActionOk() throws RetryLaterException
    {
        ...
        final GenerateEmailAction.Transition result = adnocAdminCreatedEmailAction.executeAction(adnocB2BCustomerCreationProcessModel);
    ...
    public void testExecuteActionNotOk() throws RetryLaterException
    {
        ...
        final AbstractAdnocB2BAdminEmailAction.Transition result = adnocAdminCreatedEmailAction.executeAction(businessProcessModel);
