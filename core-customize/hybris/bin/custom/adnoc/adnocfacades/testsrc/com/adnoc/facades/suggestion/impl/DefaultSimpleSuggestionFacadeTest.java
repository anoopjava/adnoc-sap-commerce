 ...
 */
package com.adnoc.facades.suggestion.impl;
...
import com.adnoc.service.suggestion.SimpleSuggestionService;
...
public class DefaultSimpleSuggestionFacadeTest
{
	...
	public void testGetReferencedProductsForBoughtCategory()
	{
		...
		given(simpleSuggestionService.getReferencesForPurchasedInCategory(category, List.of(type), user, excludeBoughtProducts, limit))
