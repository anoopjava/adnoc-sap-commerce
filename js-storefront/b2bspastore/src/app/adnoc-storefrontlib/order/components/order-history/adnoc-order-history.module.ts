...
@NgModule({
  ...
  declarations: [AdnocOrderHistoryComponent, ...moduleComponents],
  exports: [AdnocOrderHistoryComponent, ...moduleComponents],
  providers: [
    provideDefaultConfig(<CmsConfig>{
      cmsComponents: {
        AccountOrderHistoryComponent: {
          component: AdnocOrderHistoryComponent,
          guards: [AuthGuard],
        },
      },
    }),
...
export class AdnocOrderHistoryModule {}
