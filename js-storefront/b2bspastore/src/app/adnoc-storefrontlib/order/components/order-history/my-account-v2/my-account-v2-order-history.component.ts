...
import { AdnocOrderHistoryComponent } from '../adnoc-order-history.component';
...
export class MyAccountV2OrderHistoryComponent extends AdnocOrderHistoryComponent {
  protected service = inject(MyAccountV2OrderHistoryService);
  protected readonly ITEMS_PER_PAGE = 5;
  override isLoaded$ = new BehaviorSubject<boolean>(false);
  override orders$: Observable<OrderHistoryListView | undefined> = this.service
