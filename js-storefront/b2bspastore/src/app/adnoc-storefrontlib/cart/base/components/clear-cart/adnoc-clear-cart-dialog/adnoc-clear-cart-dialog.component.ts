...
import { ClearCartDialogComponentService } from './adnoc-clear-cart-dialog-component.service';
import { ICON_TYPE, FocusConfig } from '@spartacus/storefront';

@Component({
  selector: 'cx-clear-cart-dialog',
  templateUrl: './adnoc-clear-cart-dialog.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'adnoc-clear-cart-dialog' },
  standalone: false,
})
export class AdnocClearCartDialogComponent implements OnDestroy {
