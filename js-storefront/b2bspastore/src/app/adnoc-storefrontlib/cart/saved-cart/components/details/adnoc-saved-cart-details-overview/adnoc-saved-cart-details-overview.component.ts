...
@Component({
    ...
    templateUrl: './adnoc-saved-cart-details-overview.component.html',
    host: { class: 'adnoc-saved-cart-details-overview' },
    standalone: false
})
export class AdnocSavedCartDetailsOverviewComponent implements OnDestroy {
