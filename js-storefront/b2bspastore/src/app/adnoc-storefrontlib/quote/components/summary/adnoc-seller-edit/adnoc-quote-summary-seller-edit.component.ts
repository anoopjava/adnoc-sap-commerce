...
import {
  ...
  AdnocQuoteSummarySellerEditComponentService,
} from './adnoc-quote-summary-seller-edit.component.service';
import { AdnocQuoteFacade } from '../../../root/facade/AdnocQuote.facade';

@Component({
    selector: 'adnoc-quote-summary-seller-edit',
    templateUrl: './adnoc-quote-summary-seller-edit.component.html',
    standalone: false
})
export class AdnocQuoteSummarySellerEditComponent implements OnInit, OnDestroy {
