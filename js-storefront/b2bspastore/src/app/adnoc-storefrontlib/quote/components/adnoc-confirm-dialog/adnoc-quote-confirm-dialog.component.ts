...
import { ConfirmationContext } from './adnoc-quote-confirm-dialog.model';

@Component({
    selector: 'adnoc-quote-confirm-dialog',
    templateUrl: './adnoc-quote-confirm-dialog.component.html',
    changeDetection: ChangeDetectionStrategy.OnPush,
    providers: [CxDatePipe],
    standalone: false
})
export class AdnocQuoteConfirmDialogComponent implements OnInit {
