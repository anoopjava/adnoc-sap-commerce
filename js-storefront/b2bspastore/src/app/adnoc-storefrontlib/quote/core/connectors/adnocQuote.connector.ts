...
import { AdnocQuoteAdapter } from './adnocQuote.adapter';

@Injectable({
  providedIn: 'root'
})
export class AdnocQuoteConnector {
  protected quoteAdapter = inject(AdnocQuoteAdapter);
  ...
  performQuoteAction(
    ...
    return this.quoteAdapter.performQuoteAction(userId, quoteCode, quoteAction, payLoad);
  }
