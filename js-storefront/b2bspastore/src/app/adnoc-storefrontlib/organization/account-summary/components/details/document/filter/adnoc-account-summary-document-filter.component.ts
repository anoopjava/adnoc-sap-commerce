...
import {
  DocumentQueryParams,
  DocumentStatus,
} from '../../../../root/model/account-summary.model';
...
@Component({
    ...
    templateUrl: './adnoc-account-summary-document-filter.component.html',
    styleUrls: ['./adnoc-account-summary-document-filter.component.scss'],
    changeDetection: ChangeDetectionStrategy.OnPush,
    encapsulation: ViewEncapsulation.None,
    standalone: false
})
export class AdnocAccountSummaryDocumentFilterComponent
  ...
  protected getStatusOptions(): Observable<ItemType[]> {
    ...
    const translations = statusOptions.map((status) =>
      this.translation.translate(
        `accountSummaryTranslations.orgAccountSummary.statuses.${status.code}`
      )
    );
