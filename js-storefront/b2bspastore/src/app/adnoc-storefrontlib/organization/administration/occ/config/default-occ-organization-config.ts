...
export const defaultOccOrganizationConfig: AdnocOccConfig = {
  backend: {
    occ: {
      endpoints: {
        ...
        orgUnitsTree: '/users/${userId}/adnocOrgUnitsRootNodeTree',
        ...
        b2bUnitCreate:
          '/users/current/adnocOrgB2BUnits',
        b2bUnitLinkUpdate:
          '/users/current/adnoc-orgunits-hierarchy?fields=DEFAULT',
      },
    },
  },
};
