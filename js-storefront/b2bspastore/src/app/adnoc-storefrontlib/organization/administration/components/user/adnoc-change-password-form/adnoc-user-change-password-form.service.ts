...
import { AdnocFormService } from '../../shared/adnoc-form';

@Injectable({
  providedIn: 'root',
})
export class AdnocUserChangePasswordFormService extends AdnocFormService<any> {
  ...
  override getForm(item?: User): UntypedFormGroup | null {
