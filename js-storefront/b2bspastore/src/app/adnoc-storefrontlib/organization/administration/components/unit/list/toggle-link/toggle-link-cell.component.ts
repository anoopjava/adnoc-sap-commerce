...
@Component({
  ...
  standalone: false,
  host: {
    class: 'adnoc-org-toggle-link-cell',
  },
})
export class AdnocToggleLinkCellComponent extends CellComponent {
  ...
  override get hasItem(): boolean {
    return !!this.item && Object.keys(this.item).length > 0;
  }

  public override get item(): B2BUnit | null {
