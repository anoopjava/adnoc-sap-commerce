...
import { AdnocListService } from '../list/adnoc-list.service';

@Injectable()
export abstract class SubListService<
  T extends BaseItem,
> extends AdnocListService<T> {
  /**
   * The default table structure for sub lists is only showing tables with vertical layout.
   */
  protected override defaultTableStructure: ResponsiveTableConfiguration = {
   ...
   */
  protected override ghostData = { values: new Array(3) } as EntitiesModel<T>;
