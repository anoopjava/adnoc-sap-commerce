...
import { AdnocUserChangePasswordFormService } from './adnoc-user-change-password-form.service';

@Component({
  selector: 'cx-org-user-change-password-form',
  templateUrl: './adnoc-user-change-password-form.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'content-wrapper adnoc-org-user-change-password-form' },
  standalone: false,
})
export class AdnocUserChangePasswordFormComponent {
  form$: Observable<UntypedFormGroup | null>;

  constructor(
    protected itemService: UserItemService,
    protected formService: AdnocUserChangePasswordFormService,
