...
@Component({
    ...
    templateUrl: './adnoc-unit-level-order-history-filter.component.html',
    host: { class: 'adnoc-unit-level-order-history-filter' },
    standalone: false
})
export class AdnocUnitLevelOrderHistoryFilterComponent {
  iconTypes = ICON_TYPE;
