...
@Component({
  ...
  templateUrl: './adnoc-unit-level-order-history.component.html',
  changeDetection: ChangeDetectionStrategy.OnPush,
  host: { class: 'adnoc-unit-level-order-history' },
  standalone: false,
})
export class AdnocUnitLevelOrderHistoryComponent implements OnDestroy {
  private PAGE_SIZE = 5;
  sortType!: string;
  ...
  orders$: Observable<OrderHistoryList | undefined> | undefined;
