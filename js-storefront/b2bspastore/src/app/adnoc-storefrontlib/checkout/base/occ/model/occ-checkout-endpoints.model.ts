...
export interface CheckoutOccEndpoints {
  ...
  getCreditLimit?: string | OccEndpoint;

  getCurrentUser?: string | OccEndpoint;

  setPaymentTypeAndCreditLimit?: string | OccEndpoint;

  intitatePaymentCheckout?: string | OccEndpoint;

  bankTransferValidation?: string | OccEndpoint;

  retriveOrderStatus?: string | OccEndpoint;

  creditSimulationCheck?: string | OccEndpoint;
