  ...
  implements CheckoutDeliveryAddressFacade
{
  ...
  constructor(
    ...
    this.createDeliveryAddressCommand = this.commandService.create<Address>(
      (payload) =>
    ...
    this.setDeliveryAddressCommand = this.commandService.create<Address>(
      (address) =>
        this.checkoutPreconditions().pipe(
          switchMap(([userId, cartId]) => {
    ...
    this.clearDeliveryAddressCommand = this.commandService.create<void>(
      () =>
        this.checkoutPreconditions().pipe(
          switchMap(([userId, cartId]) =>
