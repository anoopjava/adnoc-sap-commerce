  ...
  implements CheckoutDeliveryModesFacade
{
  ...
  constructor(
    ...
    this.supportedDeliveryModesQuery = this.queryService.create<DeliveryMode[]>(
      () =>
    ...
    this.setDeliveryModeCommand = this.commandService.create<string>(
      (deliveryModeCode) =>
        this.checkoutPreconditions().pipe(
          switchMap(([userId, cartId]) =>
    ...
    this.clearDeliveryModeCommand = this.commandService.create<void>(
      () =>
        this.checkoutPreconditions().pipe(
          switchMap(([userId, cartId]) =>
            this.checkoutDeliveryModesConnector
