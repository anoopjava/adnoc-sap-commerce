...
export class CheckoutQueryReloadEvent extends CxEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutQueryReloadEvent';
}
...
export class CheckoutQueryResetEvent extends CxEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutQueryResetEvent';
}
...
export class CheckoutDeliveryAddressCreatedEvent extends CheckoutDeliveryAddressEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutDeliveryAddressCreatedEvent';
  /**
   * The address.
   */
  address!: Address;
...
export class CheckoutDeliveryAddressSetEvent extends CheckoutDeliveryAddressEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutDeliveryAddressSetEvent';
  /**
   * The address.
   */
  address!: Address;
...
export class CheckoutDeliveryAddressClearedEvent extends CheckoutDeliveryAddressEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutDeliveryAddressClearedEvent';
}
...
export class CheckoutDeliveryModeSetEvent extends CheckoutDeliveryModeEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutDeliveryModeSetEvent';
  /**
   * Delivery mode code.
   */
...
export class CheckoutDeliveryModeClearedEvent extends CheckoutDeliveryModeEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutDeliveryModeClearedEvent';
}
...
export class CheckoutDeliveryModeClearedErrorEvent extends CheckoutDeliveryModeEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutDeliveryModeClearedErrorEvent';
}
...
export class CheckoutSupportedDeliveryModesQueryReloadEvent extends CheckoutDeliveryModeEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutSupportedDeliveryModesQueryReloadEvent';
}
...
export class CheckoutSupportedDeliveryModesQueryResetEvent extends CheckoutDeliveryModeEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutSupportedDeliveryModesQueryResetEvent';
}
...
export class CheckoutPaymentDetailsCreatedEvent extends CheckoutPaymentDetailsEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutPaymentDetailsCreatedEvent';
  /**
   * Payment details
   */
...
export class CheckoutPaymentDetailsSetEvent extends CheckoutPaymentDetailsEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutPaymentDetailsSetEvent';
  /**
   * Payment details id
   */
...
export class CheckoutPaymentCardTypesQueryReloadEvent extends CheckoutPaymentDetailsEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutPaymentCardTypesQueryReloadEvent';
}
...
export class CheckoutPaymentCardTypesQueryResetEvent extends CheckoutPaymentDetailsEvent {
   ...
   * Event's type
   */
  static override readonly type = 'CheckoutPaymentCardTypesQueryResetEvent';
}
